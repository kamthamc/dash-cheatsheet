cheatsheet do
  title 'Git - OhMyZsh'               # Will be displayed by Dash in the docset list
  docset_file_name 'Git'    # Used for the filename of the docset
  keyword 'git'             # Used as the initial search keyword (listed in Preferences > Docsets)
  # resources 'resources_dir'  # An optional resources folder which can contain images or anything else
  
  introduction 'Git - OhMyZsh Cheatsheet'  # Optional, can contain Markdown or HTML
